...
d = fitzRoy::get_afltables_stats(start_date = "2020-01-01", end_date = "2020-09-04")

data <- d %>% select(ID,  Round, First.name, Surname, Kicks, Handballs, Marks, Hit.Outs, Contested.Possessions, Uncontested.Possessions)
#View(data)

df <- fitzRoy::get_footywire_stats(10286:10290) # Get the fantasy scores
View(df)
