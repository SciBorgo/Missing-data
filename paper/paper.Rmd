...
The simualted data set contains ... **Add short description (1-2 sentences) here of the simulated data set** 
...
# We need to add a sentence in the paper talking about this
# I'm stuck at the momement how to simulate the occurance of an injury (0,1), but with only low incidence of 1's in the dataset
# I'm also stuck how to simulate the number of sprints, but between say 50 and 200 sprints 


# Generate the x-variables
d <- get_afltables_stats(start_date = "2020-01-01", end_date = "2020-09-04")
...
# Simulate number of sprints per game
Observations = nrow(data)
sprints <- sample.int(100, # numbers of sprints between 1 and 100
           nrow(data),
           replace = T) # observations

# Simulate incidence of hamstring strain injuries
# sample.int(100, # numbers of sprints between 1 and 100
#            nrow(data),
#            replace = T) # observations

data <- merge(data, sprints)

# Impute missing values
data <- ampute(data = df[,10:43])
data <- df_first_try$amp
