...
\vspace{5mm}
**Citation:** Borg DN, Nguyen R, and Tierney NJ. (2020). Missing Data: Current Practice in Football Research and Recommendations for Improvement.
...
We recommend that researchers use missing data overview graphics (see Graphics section in [@Tierney2018]; for example, overview plots [@Tierney2017]. The panels in \@ref(fig:missing-overview) give an overall sense of the extent of missing and complete data, in an simulated injury dataset. To learn more about exploring missing values, we recommend the vignettes in naniar [@naniar], and the methods in [@Tierney2018].
