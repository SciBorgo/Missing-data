...
Methods that provide multiple imputed values for the outcome, such as multiple imputation, or using a Bayesian framework that generates a distribution of posterior values, can be appropriate for imputing the outcome as they describe the uncertainty [@Krausky2018]. Missing values in the outcome can be dealt with specially for Randomised Control Trials, see - <https://doi.org/10.1191%2F1740774504cn032oa>.

<!-- For discussion on imputing the response value, see ... [@refs]. -->
