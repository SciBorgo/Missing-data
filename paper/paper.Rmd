...
For clarity, we describe an example of missingness. An Australian Rules Football data collector 
...
There is no missing data because there is no data to be observed. Similiarly, if a study screens out individuals who 
do not meet inclusion criteria, this is not a missing value, because there is no intent for these 
values to be observed or measured. 
