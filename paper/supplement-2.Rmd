...
extractions <- tibble( # This is Table 2
  `Type of missingness reported (i.e., MCAR, MAR or MNAR)` = report_cis(gs_football_binom_statement),
  `Missing data explored` = report_cis(gs_football_binom_explored),
  `Missing observations imputed` = report_cis(gs_football_binom_imputation)
)

# pivot_then
extractions 

knitr::kable(extractions)
